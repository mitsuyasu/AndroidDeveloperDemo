...
public final class DemoArrayAdapter extends ArrayAdapter<DemoListViewItem> {
	...
	public DemoArrayAdapter(Context context, List<DemoListViewItem> objects) {
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		TextView disabledText = (TextView) view.findViewById(android.R.id.text2);
